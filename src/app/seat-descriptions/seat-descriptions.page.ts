...
@Component({
  ...
  templateUrl: './seat-descriptions.page.html',
  styleUrls: ['./seat-descriptions.page.scss'],
})
export class SeatDescriptionsPage implements OnInit {
  ...
  constructor(
    ...
    this.route.queryParams.subscribe(params => {
      if(this.router.getCurrentNavigation()!.extras.state) {
        this.inputSeat = this!.router!.getCurrentNavigation()!.extras!.state;
      }
    })
  }
